        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <div class="cartitems" style="margin: 20px;">
                    <a href="cart.php" class="cart position-relative d-inline-flex" aria-label="View your shopping cart">
          <i class="fas fa fa-shopping-cart fa-lg"></i>
          <span class="cart-basket d-flex align-items-center justify-content-center" id="numorder">
            0
          </span>
        </a>
                    </div>
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                    ...
                    <p style="font-size: revert;
    margin: 12px;"><?php echo "Welcome " . $_SESSION['username']; ?></p>
                    <img src="<?php echo $_SESSION['image']; ?>" alt="" srcset="" style="width: 60px;
    border-radius: 40px;">
                    <button type="button" class="btn btn-outline-dark" style="width: 100px;
    height: 40px;
    margin: auto;
    border-radius: 30px;" id="logout">log Out</button>
                </div>
            </div>
        </div>
    </nav>
